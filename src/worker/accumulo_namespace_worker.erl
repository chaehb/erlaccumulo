...
%%% @doc
%%%		Currently not supported proxy in 1.6.1
%%% @end
%%% Created : 14. Sep 2014 00:41
%%%-------------------------------------------------------------------
-module(accumulo_namespace_worker).
...
% handle_call(Request, _From, State = {ConnLength, Conns}) ->
% 	ConIndex = erlaccumulo_util:worker_connection_index(?MODULE,ConnLength),
%     {reply, ok, State}.
%
